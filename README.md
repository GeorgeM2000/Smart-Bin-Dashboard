...
<p>Ο χρήστης έχει τις εξής δυνατότητές
  <ul>
    ...
    <li>Ανάκτηση και υπολογισμός βέλτιστης διαδρομής</li>
...
Ο κάθε χρήστης(οδηγός) θα πρέπει πριν αρχίσει να χρησιμοποιεί τη πλατφόρμα να δημιουργήσει ένα λογαριασμό και να συνδεθεί. Αυτό απαιτείται διότι στον κάθε χρήστη αποδίδεται ένα σύνολο από περιοχές που θα πρέπει να καλύψει. 
</p>
